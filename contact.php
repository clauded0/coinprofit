            ...
            <div class="uk-container uk-margin-small-top uk-margin-bottom">
                <div class="uk-grid uk-flex uk-flex-center in-contact-6">
                    ...
                    <div class="uk-width-1-1">
                       ...
                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2482.87923605138!2d-0.08021028490406011!3d51.515431517938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761cb33132e597%3A0xd7b9abe6e3a51e3a!2s133%20Houndsditch%2C%20London%20EC3A%207DB%2C%20UK!5e0!3m2!1sen!2sng!4v1678609094485!5m2!1sen!2sng" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    <div class="uk-width-3-5@m">
                        <div class="uk-grid uk-child-width-1-3@m uk-margin-medium-top uk-text-center" data-uk-grid>
                            <div>
                                ...
                                <p class="uk-margin-small-top">133 Houndsditch, London EC3A 7BX, United Kingdom.</p>
                            </div>
                            <div>
                                <h5 class="uk-margin-remove-bottom"><i class="fas fa-envelope fa-sm uk-margin-small-right"></i>Email</h5>
                                <p class="uk-margin-small-top uk-margin-remove-bottom">info@cmdmarkets.com</p>
                                <p class="uk-margin-small-top uk-margin-remove-bottom">support@cmdmarkets.com</p>
                                <p class="uk-text-small uk-text-muted uk-text-uppercase">for public inquiries</p>
                            </div>
                            <div>
                                <h5 class="uk-margin-remove-bottom"><i class="fas fa-phone-alt fa-sm uk-margin-small-right"></i>Whatsapp</h5>
                                <p ><a class="uk-text-small uk-text-muted uk-text-uppercase" href="https://wa.me/14048602239">+1 404 860 2239</a></p>
            ...
            <div class="uk-container uk-margin-top">
                <div class="uk-grid">
                    ...
                    <div class="uk-width-expand@m uk-flex uk-flex-right@m">
                        <ul class="uk-list uk-link-text">
                            <li><img class="uk-margin-small-right in-margin-top-30@s" src="img/in-logo-footer.png" data-src="img/in-logo-footer.png" alt="coinPROFIT" width="134" height="23" data-uk-img="">
